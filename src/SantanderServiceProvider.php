...
class SantanderServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(WorkspaceManagement::class, function ($app) {
            return new WorkspaceManagement($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(BankAccounts::class, function ($app) {
            return new BankAccounts($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(BankSlipPayments::class, function ($app) {
            return new BankSlipPayments($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(BarcodePayments::class, function ($app) {
            return new BarcodePayments($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(VehicleTaxesPayments::class, function ($app) {
            return new VehicleTaxesPayments($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(TaxesByFieldsPayments::class, function ($app) {
            return new TaxesByFieldsPayments($app->make(SantanderApiClient::class));
        });

        $this->app->singleton(PixAutomatic::class, function ($app) {
            return new PixAutomatic($app->make(SantanderApiClient::class));
        });
        ...
        $this->app->singleton(SantanderSdk::class, function ($app) {
            return new SantanderSdk(
                ...
                $app->make(WorkspaceManagement::class),
                $app->make(BankAccounts::class),
                $app->make(BankSlipPayments::class),
                $app->make(BarcodePayments::class),
                $app->make(VehicleTaxesPayments::class),
                $app->make(TaxesByFieldsPayments::class),
                $app->make(PixAutomatic::class)
            );
        });
    }
